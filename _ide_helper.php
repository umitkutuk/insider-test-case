...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function safelyPaginate($perPage = null, $columns = [], $pageName = 'page', $page = null)
        {
                        return \Illuminate\Database\Query\Builder::safelyPaginate($perPage, $columns, $pageName, $page);
        }
